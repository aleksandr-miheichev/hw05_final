# Generated by Django 4.0.6 on 2022-07-12 00:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='post',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='posts.group', verbose_name='Сообщество к которому относится пост'),
        ),
        migrations.AlterField(
            model_name='post',
            name='pub_date',
